...
@MainActor
public struct UpdateRenderNode<Content: RenderNode & Sendable>: RenderNodeWrapper {
    public let content: Content
    public let update: @MainActor @Sendable (Content.View) -> Void
...
@MainActor
public struct KeyPathUpdateRenderNode<Value: Sendable, Content: RenderNode & Sendable>: RenderNodeWrapper {
    public let content: Content
...
@MainActor
public struct IDRenderNode<Content: RenderNode & Sendable>: RenderNodeWrapper {
    public let content: Content
...
@MainActor
public struct AnimatorRenderNode<Content: RenderNode & Sendable>: RenderNodeWrapper {
    public let content: Content
...
@MainActor
public struct ReuseStrategyRenderNode<Content: RenderNode & Sendable>: RenderNodeWrapper {
    public let content: Content
...
extension RenderNode {
    ...
    subscript<Value: Sendable>(dynamicMember keyPath: ReferenceWritableKeyPath<View, Value>) -> (Value) -> KeyPathUpdateRenderNode<Value, Self> {
        { with(keyPath, $0) }
    }
    ...
    public func with<Value: Sendable>(_ keyPath: ReferenceWritableKeyPath<View, Value>, _ value: Value) -> KeyPathUpdateRenderNode<Value, Self> {
    ...
    public func update(_ update: @escaping @MainActor @Sendable (View) -> Void) -> UpdateRenderNode<Self> {
...
public struct AnimatorWrapperRenderNode<Content: RenderNode>: RenderNodeWrapper {
    ...
    var insertBlock: (@MainActor @Sendable (ComponentDisplayableView, UIView, CGRect) -> Void)?
    var updateBlock: (@MainActor @Sendable (ComponentDisplayableView, UIView, CGRect) -> Void)?
    var deleteBlock: (@MainActor @Sendable (ComponentDisplayableView, UIView, @escaping @MainActor @Sendable () -> Void) -> Void)?
...
extension RenderNode {
    ...
    func animateUpdate(passthrough: Bool = false, _ updateBlock: @escaping (@MainActor @Sendable (ComponentDisplayableView, UIView, CGRect) -> Void)) -> AnimatorWrapperRenderNode<Self> {
    ...
    func animateInsert(_ insertBlock: @escaping @MainActor @Sendable (ComponentDisplayableView, UIView, CGRect) -> Void) -> AnimatorWrapperRenderNode<Self> {
    ...
    func animateDelete(_ deleteBlock: @escaping @MainActor @Sendable (ComponentDisplayableView, UIView, @escaping @MainActor @Sendable () -> Void) -> Void) -> AnimatorWrapperRenderNode<Self> {
