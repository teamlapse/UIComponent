...
extension Component {
    ...
    public func animateUpdate(passthrough: Bool = false, _ updateBlock: @escaping (@MainActor (ComponentDisplayableView, UIView, CGRect) -> Void)) -> AnimatorWrapperComponent<Self> {
        ModifierComponent(content: self) {
    ...
    /// - Returns: An `AnimatorWrapperComponent` containing the modified component.
    public func animateInsert(_ insertBlock: @escaping (@MainActor (ComponentDisplayableView, UIView, CGRect) -> Void)) -> AnimatorWrapperComponent<Self> {
        ModifierComponent(content: self) {
    ...
    /// - Returns: An `AnimatorWrapperComponent` containing the modified component.
    public func animateDelete(_ deleteBlock: @escaping @MainActor (ComponentDisplayableView, UIView, @escaping () -> Void) -> Void) -> AnimatorWrapperComponent<Self> {
        ModifierComponent(content: self) {
